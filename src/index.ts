...
(() => {
    ...
    class Reminder implements Task {
        ...
        description: string =""; //ver aspas caso o código de errado
    ...
    const taskView = {
        ...
        // render vai receber uma lista de tasks
        render(tasks: Array<Task>, mode: Mode) {
            // Clear view
            const tasksList = document.getElementById('tasksList');
            //loop que esvazia a lista
    ...
    const TaskController = (view: typeof taskView) => {
        ...
        // quando a view será renderizada e mostar no html
